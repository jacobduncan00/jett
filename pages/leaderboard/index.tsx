  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setLeaderboardEntries(response.data.sort(function(a: LeaderboardEntry, b: LeaderboardEntry) {
          // b - a = descending
          // a -b = ascending
          return b.wpm - a.wpm;
        }));
  ...
  return (
    <div>
      ...
      {leaderboardEntries.map(entry => (
        <LeaderboardCard
        key={Math.random().toString(36).substr(2, 9)} // random key to make error go away
          className="color: red;"
